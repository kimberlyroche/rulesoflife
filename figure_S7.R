...
# ------------------------------------------------------------------------------
#
#   Figure S7 - abundance is not a driver of correlation; a) distributions of
#               differences in mean CLR in top 2.5% most universal vs. all other
#               pairs and b) distributions of mean CLR for each partner in same
#               pairs
#
# ------------------------------------------------------------------------------
...
if(FALSE) {
  ...
  ggsave(file.path("output", "figures", "S7_alt.png"),
         p,
         dpi = 100,
         units = "in",
         height = 5,
