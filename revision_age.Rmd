...
ggplot() +
  geom_segment(data = edge_df,
               ...
               color = "#aaaaaa") +
  geom_point(data = centroid_df %>% mutate(group = factor(group, levels = c("juvenile", "prime", "older"))),
             mapping = aes(x = x_mean, y = y_mean, fill = group),
             size = 3, shape = 23, stroke = 1.25) +
  geom_point(data = host_groups %>% mutate(group = factor(group, levels = c("juvenile", "prime", "older"))),
