...
option_list = list(
  ...
  make_option(c("--scrambletime"), type = "logical", default = FALSE,
              help = "permuted data in time across hosts", metavar = "logical"),
...
fit <- fit_GP(sname = opt$sname,
              ...
              var_scale_taxa = opt$var_scale_taxa,
              var_scale_samples = opt$var_scale_samples,
              use_adam = opt$use_adam,
              scramble_time = opt$scramble)
